    ...
    <Layout title={"CakeFantasy - HomePage"}>
      ...
      <div className="home-column1">
        ...
        <p className="category">
          <i class="fas fa-bullseye" style={{ fontSize: "20px" }}></i>
          <a href="s" style={{ textDecoration: "none", color: "#772196" }}>
            &nbsp;&nbsp;&nbsp; Birthday Cakes
          </a>
        </p>
        <p className="category">
      ...
      <div className="home-column3">
        <div class="container">
          <center>
            <img src={add1} alt="add2" style={{ width: "95%" }} />
          </center>
        ...
        <div>
          ...
          <center>
            <img
              src={add5}
              alt="add2"
              style={{ width: "95%", height: "220px", marginTop: "20px" }}
            />
          </center>
        </div>
      </div>
